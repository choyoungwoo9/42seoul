...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/03 09:19:44 by jungyeki          #+#    #+#             */
/*   Updated: 2022/10/09 15:33:03 by youngwch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main (void)
{
	...
	printf("%d", ft_atoi_base("    ----++---+jungyeye0224", "jungy eki"));
	printf("\nstr :     ----++---+jungyeye0224, base : jungy eki\n");
